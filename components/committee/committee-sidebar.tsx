        ...
        {navItems.map((item, index) => {
          ...
          return (
            ...
            >
              ...
              >
                <Icon className={cn("h-5 w-5 shrink-0", isActive ? "text-primary" : "text-muted-foreground/70")} />
                {item.name}
              </Link>
            </motion.div>
          );
  ...
  return (
    ...
    >
      ...
      <motion.nav
        ...
        className="absolute left-0 top-0 h-full w-72 bg-card border-r border-border shadow-xl"
      >
        ...
        <div className="absolute bottom-0 w-72 p-4 border-t border-border">
          <div className="text-xs text-muted-foreground">
            <p className="font-medium">Evaluation Period</p>
            <p>Open until April 30, 2026</p>
          </div>
